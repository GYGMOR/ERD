...
export const TicketsView = () => {
  ...
  <div style={{ maxWidth: 1200, margin: '0 auto' }}>
    ...
    {/* Stats mini-cards */}
    <div className="grid-responsive grid-cols-1-3" style={{ marginBottom: 24 }}>
